/***
 Проверьте, принадлежит ли точка данной закрашенной области (3795.png)
 ...
 координаты точки, вызвать функцию IsPointInArea и в 
...
{                                                   
    return ( (pow(2,2)>=(pow (x+1,2))+(pow (y-1,2)) && (y>= -x) && (y>=2*x+2)) || pow(2,2)<=(pow (x+1,2))+(pow (y-1,2)) && (y<=-x) && (y<=2*x+2) );
}              
int main()
{
    double x,y;
